  ...
  const handleDownloadPlan = () => {
    ...
    try {
      ...
      for (let i = 1; i <= pageCount; i++) {
        ...
        doc.text(
          `Generated by SemSense AI - 4aksharampadikk | Page ${i} of ${pageCount}`,
          pageWidth / 2,
          285,
          { align: 'center' }
        );
        ...
        {step === 'form' ? (
          <div>
            <div className="flex items-center gap-3 mb-2">
              <img src="/semsense-logo.png" alt="SemSense AI Logo" className="w-12 h-12 object-contain" />
              <h1 className="text-4xl font-bold bg-gradient-to-r from-fuchsia-400 via-purple-300 to-indigo-300 bg-clip-text text-transparent">SemSense AI</h1>
            </div>
